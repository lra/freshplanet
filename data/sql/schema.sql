...
CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT, email VARCHAR(255) UNIQUE, firstname VARCHAR(255), lastname VARCHAR(255), game_board LONGBLOB, game_time INTEGER, last_action_at DATETIME, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL);
